...
<body>
	<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr class="info">
				...
				<select class="chzn-select" name="ROLE_ID" id="role_id" data-placeholder="请选择职位" >
						...
						<c:forEach items="${roleList}" var="role">
							<option value="${role.ZD_ID }" <c:if test="${pd.ROLE_ID==role.ZD_ID}">selected</c:if>>${role.NAME }</option>
						</c:forEach>
					  	</select>
				</td>
				<td>
					<select class="chzn-select" name="EMAP_ID" id="emap_id" data-placeholder="请选择部门">
						<option value=""></option>
						<c:forEach items="${emapList}" var="emap">
							<option value="${emap.EMAP_ID }" <c:if test="${pd.EMAP_ID==emap.EMAP_ID}">selected</c:if>>${emap.EMAPNAME }</option>
						</c:forEach>
					  	</select>
				</td>
			</tr>
			...
			<tr class="info">
				<td><input type="file" name="HEAD" class="input_txt" value="${pd.HEAD }"  /></td>
