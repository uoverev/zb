package com.ypkj.zubu.tencent.protocol.pay_protocol;
...
import com.ypkj.zubu.tencent.common.RandomStringGenerator;
...
//        setSdk_version(Configure.getSdkVersion());
        ...
        setTrade_type("APP");
        setNotify_url("http://121.41.0.158:8071/UIORACLE/appKu/query.do?STYPE=111133");
        //根据API给的签名规则进行签名
