...
public class Const {
	...
	public static final String IMAGEURL = "admin/config/IMAGEURL.txt";
	...
	public static final String[] APP_LOGIN_VALUE_ARRAY = new String[]{"用户帐号","密码"};
	...
	//app注册接口_请求协议参数)
	public static final String[] APP_IN_PARAM_ARRAY = new String[]{"num","key"};
	public static final String[] APP_IN_VALUE_ARRAY = new String[]{"接口编号","校验码","查询条件"};
